...
function UserAvatar({user,size=36}){
  ...
  return(
    <div style={{width:size,height:size,borderRadius:"50%",background:bg,display:"flex",alignItems:"center",justifyContent:"center",fontSize:size*0.48,flexShrink:0,border:"2px solid rgba(255,255,255,0.3)"}}>
      {emoji}
    </div>
  );
}
    ...
    if(step==="register")return(
      <div style={wrap}><div style={inner}>
        ...
        <div style={{marginBottom:14}}>
          <label style={lbl}>Emoji / Avatar</label>
          <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
            {AVATAR_EMOJIS.map((em,i)=>(
              <div key={i} onClick={()=>setNewAvatarIdx(i)} style={{width:42,height:42,borderRadius:10,display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,cursor:"pointer",border:newAvatarIdx===i?"2px solid #1a56db":"1px solid #e5e7eb",background:newAvatarIdx===i?"#e8f0fe":"#fff"}}>{em}</div>
            ))}
          </div>
        </div>
        <div style={{marginBottom:20}}>
            ...
            <div style={{background:"#fff",borderRadius:14,padding:16,border:"1px solid #e5e7eb"}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  ...
                  {isEsp&&<div style={{width:28,height:28,background:"#7e3af2",borderRadius:6,display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",fontWeight:700,fontSize:11}}>ESPE</div>}
